...
public class ResumeAnalysisEntity {
    ...
    private Integer contentScore;//内容完整性（教育/经历/技能）
    private Integer structureScore;//结构清晰度（排版/层次）
    private Integer skillMatchScore;//技能匹配度（具体程度/相关性）
    private Integer expressionScore;//表达专业性（量化成果）
    private Integer projectScore;//项目经验（清晰度/深度）
